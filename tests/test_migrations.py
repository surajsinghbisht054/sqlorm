...
class TestColumnAdditions:
    ...
    def test_add_nullable_column(self):
        ...
        # Insert data
        execute_raw_sql(
            "INSERT INTO add_column_test2 (name) VALUES (?)",
            ["Row 1"],
            fetch=False
        )
    ...
    def test_add_integer_column(self):
        ...
        execute_raw_sql(
            "INSERT INTO add_column_test3 (name) VALUES (?)",
            ["Test"],
            fetch=False
        )
...
class TestSchemaChanges:
    ...
    def test_rename_column_sqlite(self):
        ...
        execute_raw_sql(
            "INSERT INTO rename_test (old_name) VALUES (?)",
            ["Test Value"],
            fetch=False
        )
    ...
    def test_sync_schema_adds_columns(self):
        ...
        from sqlorm import execute_raw_sql, Model, fields
        ...
        # Insert data
        execute_raw_sql(
            "INSERT INTO sync_test (name) VALUES (?)",
            ["Original"],
            fetch=False
        )
...
class TestMigrationEdgeCases:
    ...
    def test_recreate_table_with_data_preservation(self):
        ...
        result = execute_raw_sql("SELECT id, name, new_field FROM recreate_test ORDER BY id")
        assert len(result) == 2
    ...
    def test_handle_data_type_changes(self):
        ...
        execute_raw_sql(
            "INSERT INTO type_change_test (amount) VALUES (?)",
            ["100"],
            fetch=False
        )
        execute_raw_sql(
    ...
    def test_migrate_all_models(self):
        ...
        from sqlorm import Model, fields
        from sqlorm.base import migrate_all, create_all_tables
